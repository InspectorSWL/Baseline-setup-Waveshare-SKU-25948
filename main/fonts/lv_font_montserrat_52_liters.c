 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --size 72 --bpp 4 --format lvgl --font c:\Users\PLC\Downloads\ESP32-S3-Touch-LCD-4.3-Demo (2)\ESP32-S3-Touch-LCD-4.3-Demo\ESP-IDF\08_lvgl_Porting\main\fonts\Montserrat-Bold.ttf --symbols  ,.0123456789L --no-compress --force-fast-kern-format --lv-include lvgl.h --lv-font-name lv_font_montserrat_52_liters -o c:\Users\PLC\Downloads\ESP32-S3-Touch-LCD-4.3-Demo (2)\ESP32-S3-Touch-LCD-4.3-Demo\ESP-IDF\08_lvgl_Porting\main\fonts\lv_font_montserrat_52_liters.c
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_52_LITERS
#define LV_FONT_MONTSERRAT_52_LITERS 1
#endif

#if LV_FONT_MONTSERRAT_52_LITERS
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 302, .box_w = 15, .box_h = 25, .ofs_x = 2, .ofs_y = -11},
    {.bitmap_index = 188, .adv_w = 302, .box_w = 15, .box_h = 15, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 301, .adv_w = 782, .box_w = 45, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 1471, .adv_w = 452, .box_w = 23, .box_h = 50, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2046, .adv_w = 680, .box_w = 41, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3092, .adv_w = 682, .box_w = 42, .box_h = 52, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 4184, .adv_w = 794, .box_w = 47, .box_h = 50, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5359, .adv_w = 685, .box_w = 41, .box_h = 52, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6425, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 7543, .adv_w = 714, .box_w = 42, .box_h = 50, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 8593, .adv_w = 760, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 9711, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10829, .adv_w = 696, .box_w = 38, .box_h = 50, .ofs_x = 5, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_52_liters = {
#else
lv_font_t lv_font_montserrat_52_liters = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_52_LITERS*/
